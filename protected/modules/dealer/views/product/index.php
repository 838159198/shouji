        ...
        <div class="col-md-10">
            ...
            <div class="alert alert-success">
                ...
                <p style="margin-top: -15px;"><b class="tongji">下载说明：<br>
                        ...
                        2. 统计软件实际打包大小可能会有差异，不影响正常数据统计。<br>
                            ...
                            {
                                echo "<b style='color: green;font-family: Arial, monospace;font-size:16px;font-weight:bold;'>V8.0--2017-01-04</b>";
                            }
                            else
                            {
                                echo "<b style='color: red; font-family: Arial, monospace;font-size:16px;font-weight: bold;'>V8.0--2017-01-04</b>";
                            }
                            ?>
            ...
            <?php if($agent!=69 || ($agent==69 && $uid==69) || ($agent==69 && $uid==722) || $manageid==1)
            {
                $this->widget('zii.widgets.CListView', array(
                    ...
                    'itemView' => '_view',
                    'summaryText' => '',
                    'viewData' => array('resourceStatus' => $resourceStatus,'uid'=>$uid),
                ));
            } ?>

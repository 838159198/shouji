...
<script type="text/javascript">
    ...
    var MAIL_URL = '<?php echo $this->createUrl('/dealer/mail/count') ?>';
</script>
<style type="text/css">
    .qtip{
        margin-top:8px;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo Yii::app()->createUrl("/dealer");?>">首页</a></li>
                <li><a href="<?php echo Yii::app()->createUrl("/dealer/product");?>">产品列表</a></li>
                <li>
                    <?php echo CHtml::link('消息', array('mail/index'), array('id' => 'tipmail', 'title' => '没有新消息')) ?>
                </li>
                <li><a href="<?php echo Yii::app()->createUrl("/dealer/mail/index");?>" id="infocount"></a></li>
                <li><a href="/">服务中心</a></li>
            </ul>

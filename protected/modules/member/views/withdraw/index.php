            ...
            <div class="row">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            本月预估收益：<span class="money"><?php echo $modelBill->cy<=0?'0.00':$modelBill->cy;?></span>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的余额：<span class="money"><?php echo $modelBill->surplus ?></span>元
<!--                            --><?php
/*                            $m=Member::model()->getById($this->uid);
                ...
                <?php if($bank_status==false){?>
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="alert alert-danger" role="alert">请先填写财务信息，才可以提现哦 ^_^ <a href="/member/info/bank" class="lable">现在就去填写财务信息</a> </div>
                        </div>
                    </div>
                <?php }else{?>
                    <div class="panel panel-success">

...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            $columns[] = array('name' => "注册时间", 'headerHtmlOptions' => array('width'=>'30%'),'value' => 'isset($data[\'jointime\'])?$data[\'jointime\']:"" ','type'=>'html');
            $columns[] = array('name' => "用户ID", 'value' => 'isset($data[\'username\'])?$data[\'username\']:""');
            $columns[] = array('name' => "设备数量", 'value' => 'isset($data[\'usercounts\'])?$data[\'usercounts\']:""');

    ...
    $(function()
        {
            ...
            if(bank=="支付宝")
            {
                $("#bank_num label").text('支付宝账号');
                $("#bank_num input").attr('placeholder','请输入支付宝账号');
            ...
            $("#Member_bank").click(function(){
                ...
                {
                    $("#bank_num label").text('银行卡号');
                    $("#bank_num input").attr('placeholder','请输入银行卡号');
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="form-group" id="bank_num">

<div class="page-header app_head">
    <h1 class="text-center text-primary">页面修改 <small></small></h1>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <?php echo $form->textField($model, 'pathname', array('class'=>'form-control','placeholder' => '请输入英文','readonly'=>'readonly')); ?>
                </div>

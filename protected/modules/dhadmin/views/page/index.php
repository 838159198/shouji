<div class="page-header app_head">
    <h1 class="text-center text-primary">页面列表 <small></small></h1>
</div>
<div class="row-fluid">
    <div class="app_button">
        <a href="<?php echo $this->createUrl("page/create");?>" class="btn btn-success">添加内容</a>
    </div>
</div>
<?php
//判断是否有提示信息
...
//关于分页器这个array，具体还有很多属性，可参考CLinkPager的API
    ...
    'columns' => array(
        ...
        array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("dhadmin/page/update",array("id"=>$data->id));',
            'deleteButtonUrl'=>'Yii::app()->createUrl("dhadmin/page/del",array("id"=>$data->id));',
            //'template' => $template,

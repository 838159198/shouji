...
$this->menu = array(
    array('label' => '用户路由器列表', 'url' => array('softroute/index')),
    array('label' => '添加路由器', 'url' => array('softroute/routeAdd')),
    array('label' => '在线路由器', 'url' => array('softroute/test2')),
);
?>
<style type="text/css">
    select {
...
<h4 class="text-center">用户路由器管理</h4>
<?php
    ...
    'columns' => array(
       ...
       /* array(
        ...
        array(
            'name'=>'status',
            'value'=>'$data->xstatus',
            'filter'=>CHtml::listData(Softroute::model()->listDataStatus,'key','value'),
            'type'=>"html",
            'htmlOptions'=>array('style'=>'text-align:center;'),
        ),
        //'lasttime',
        ...
        array(
            'header'=>'操作',
            'class' => 'CButtonColumn',
            'updateButtonUrl'=>'Yii::app()->createUrl("dhadmin/softroute/routeUpdate",array("id"=>$data->id));',

...
?>
    ...
    <div class="breadcrumbs">
       <a href="/dhadmin/softroute/index">用户路由器列表</a> &raquo; <span>添加路由器</span></div>
    <h4 class="text-center">添加用户路由器</h4>
...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <?php echo $form->textField($model, 'route_number', array('class'=>'form-control')); ?>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <?php echo $form->dropDownList($model,'type',array("0"=>"0","1"=>"1"),array("class"=>"form-control"));?>
            </div>

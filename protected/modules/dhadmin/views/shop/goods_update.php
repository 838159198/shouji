...
<div class="breadcrumbs">
    <a href="/dhadmin/shop/index">首页</a> &raquo; <a href="/dhadmin/shop/index">商品列表</a> &raquo; <span>更新商品</span></div>
<h4 class="text-center">更新商品</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <?php echo $form->dropDownList($model,'recommend',array("0"=>"普通","1"=>"推荐"),array("class"=>"form-control"));?>
                    </div>
                    <div class="col-md-5"><?php echo $form->error($model, 'recommend',array('class'=>"errorMessageTips"));?></div>
                </div>
                <div class="form-group">

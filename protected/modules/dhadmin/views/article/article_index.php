<div class="page-header app_head">
    <h1 class="text-center text-primary">文章列表 <small></small></h1>
</div>
<!--<div class="row">
...
//    'filter' => $model,
    'columns' => array(
        ...
        array(
            ...
            'updateButtonUrl'=>'Yii::app()->createUrl("dhadmin/article/update",array("id"=>$data->id));',
            'deleteButtonUrl'=>'Yii::app()->createUrl("dhadmin/article/del",array("id"=>$data->id));',
            //'template' => $template,

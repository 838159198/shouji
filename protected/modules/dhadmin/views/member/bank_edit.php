...
<div class="page-header app_head">
    <h1 class="text-center text-primary"><?php echo $data['username'];?> <small>修改用户银行信息</small></h1>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5"><?php echo $form->error($data, 'bank_site',array('class'=>"errorMessageTips"));?></div>
            </div>
            <div class="form-group">

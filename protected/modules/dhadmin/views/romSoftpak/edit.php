<div class="page-header app_head">
    <h1 class="text-center text-primary">统计软件更新<small></small></h1>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5"><?php echo $form->textField($model,"serial_number",array("class"=>"form-control","readonly"=>"readonly")); ?></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5"><?php echo $form->textField($model,"type",array("class"=>"form-control","readonly"=>"readonly")); ?></div>

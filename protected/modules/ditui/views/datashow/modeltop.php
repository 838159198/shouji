<div class="page-header app_head">
    <h1 class="text-primary"><span id="mh1">&nbsp;</span>热门机型排行</h1>
</div>
<style type="text/css">
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            $columns[] = array('name' => "热门机型", 'headerHtmlOptions' => array('width'=>'50%'),'value' => '$data[\'model\'] ','type'=>'html');
            $columns[] = array('name' => "机型数量", 'value' => '$data[\'counts\']+10000');

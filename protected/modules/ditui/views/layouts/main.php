...
<script type="text/javascript">
    ...
    var MAIL_URL = '<?php echo $this->createUrl('/ditui/mail/count') ?>';
</script>
<style type="text/css">
    .qtip{
        margin-top:8px;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo Yii::app()->createUrl("/ditui");?>">首页</a></li>
                <li><a href="<?php echo Yii::app()->createUrl("/ditui/product");?>">产品列表</a></li>
                <li>
                    <?php echo CHtml::link('消息', array('mail/index'), array('id' => 'tipmail', 'title' => '没有新消息')) ?>
                </li>
                <li><a href="<?php echo Yii::app()->createUrl("/ditui/mail/index");?>" id="infocount"></a></li>

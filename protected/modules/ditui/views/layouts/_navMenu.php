...
<div class="list-group" style="min-width:203px">
    ...
    <a href="<?php echo Yii::app()->createUrl("/ditui/product");?>" class="list-group-item <?php if($a=="product_index"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 产品列表</a>
    <a href="<?php echo Yii::app()->createUrl("/ditui/datashow/activatop");?>" class="list-group-item <?php if($a=="datashow_activatop"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 应用安装排行</a>
    <a href="<?php echo Yii::app()->createUrl("/ditui/datashow/instalcheck");?>" class="list-group-item <?php if($a=="datashow_instalcheck"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 安装量分析</a>
    <a href="<?php echo Yii::app()->createUrl("/ditui/datashow/instruction");?>" class="list-group-item <?php if($a=="datashow_instruction"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 业务说明</a>
    ...
    <?php
        ...
        if($m["type"]==1 || $uid==760)
        {
            echo '<a href="/ditui/incomes/index" class="list-group-item"><span class="glyphicon glyphicon-yen" aria-hidden="true"></span> 子用户收益</a>';
        }
    ?>
    <div  class="list-group-item  activea "><b>个人信息</b></div>
    <a href="<?php echo Yii::app()->createUrl("/ditui/info");?>" class="list-group-item <?php if($a=="info_index"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> 我的信息</a>
    <a href="<?php echo Yii::app()->createUrl("/ditui/info/edit");?>" class="list-group-item <?php if($a=="info_edit"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> 资料修改</a>
    <?php if($agent!=69 ||($agent==69 && $uid==69) || $manageid==1): ?>
    <a href="<?php echo Yii::app()->createUrl("/ditui/info/bank");?>" class="list-group-item <?php if($a=="info_bank"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-credit-card" aria-hidden="true"></span> 财务信息修改</a>
    <?php endif; ?>
    <a href="<?php echo Yii::app()->createUrl("/ditui/info/password");?>" class="list-group-item <?php if($a=="info_password"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span> 密码修改</a>

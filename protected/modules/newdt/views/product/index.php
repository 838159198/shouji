...
<?php
	...
	$type=Common::getUserType($member["type"]);
    $urom=RomSoftpak::model()->find('status=0 and uid=:uid and type=:type',array(":uid"=>$uid,":type"=>$type));
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="alert alert-success" id="mlist">
                <h4 class="tongji" style=" color:#4A515B"> 速推装机助手<hr style="margin-top: 6px;"></h4>
                ...
                下载速推装机助手 -> 登录账号 -> 一键安装 <br>
                            <?php
                            $newday=date('Y-m-d H:i:s',strtotime('+10 Day',strtotime('2017-11-01 00:00:00')));
                            $today=date('Y-m-d H:i:s');
                            if(strtotime($today)>strtotime($newday)) {echo "<b style='color: green;font-family: Arial, monospace;font-size:16px;font-weight:bold;'>V1.16.1025.20272--2017-11-01</b>";}
                            else {echo "<b style='color: red; font-family: Arial, monospace;font-size:16px;font-weight: bold;'>V1.16.1025.20272--2017-11-01</b>";}
                            ?>
                    ...
                    <div class="btn-group btn-group1" style="margin-left:-5px; margin-top:1px;" id="mh2">
                        ...
                        {
                            echo '<a class="btn btn-primary" href="http://df.sutuiapp.com/uploads/pczs/StInstallTool.exe">点击下载</a>';
                        }
                        else
                        {
                        ...
                        ?>
                       <a class="btn btn-<?php echo $member['launcher_install']==1? 'success':'danger'?>" href="javascript:void()" onclick="aa()" style="margin-left: 20px"><?php echo $member['launcher_install']==1? '安装桌面':'不安装桌面'?></a>
                    </div>
                </div>
...
<!--                    <img style="float:left;width:116px;height:116px;" src="--><?php //echo $codeurl; ?><!--" >-->
            ...
            <?php if($agent==99 || $agent==96 || $manageid==1 || $agent==707)
            {

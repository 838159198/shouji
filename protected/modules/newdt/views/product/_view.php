        ...
        <div class="row tray-inner">
            <div class="tab-content">
                <div id="tab8_1" class="tab-pane active">
                    ...
                    <?php }?>
                    <script src="/css/newdt/newdt.js"></script>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" cellpadding="0" cellspacing="0" class="rom-down">
                                    ...
                                    <tr class="success">
                                        ...
                                        <?php if($agent!=707 && $uid!=707){?> <th>价格</th><?php }?>
                                        <?php if($agent==99 || $manageid==1){?> <th>激活规则</th><?php }?>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($agent==99 || $manageid==1){?> <td><?php echo $vt['activate_instructions'];?></td><?php }?>

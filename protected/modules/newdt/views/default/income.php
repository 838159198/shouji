...
$columns[] = array('name'=>'activate','value' => 'is_numeric($data[\'activate_income\']) ? round($data[\'activate_income\'],2) : $data[\'activate_income\']', 'header' => '激活收益');
//$columns[] = array('name' => 'amount','value' => '$data[\'id\']', 'header' => '总激活量');
if($agent==96)
{
    $columns[] = array('name'=>'activate','value' => 'is_numeric($data[\'activate_income\']) ? round($data[\'activate_income\'],2) : $data[\'activate_income\']', 'header' => '总收益');
}
else
{
    $columns[] = array('name' => 'amount','value' => 'is_numeric($data[\'all_income\']) ? round($data[\'all_income\'],2) : $data[\'all_income\'] ', 'header' => '总收益');
}
...
<script type="text/javascript" src="/css/newdt/default.js"></script>

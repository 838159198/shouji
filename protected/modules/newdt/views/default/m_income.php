...
echo CHtml::beginForm('income?id='.$id, 'get', array('class'=>'form-inline')),
CHtml::label('选择月份', 'm'),
...
$columns[] = array('name' => 'amount','value' => 'number_format($data[\'amount\'],2)', 'header' => '收益总额');
...
<br>
<label class="btn btn-info" style="margin-bottom: 10px;">合计：<?php echo number_format($sum, 2) ?></label>

 ...
 * Time: 11:31
 */
RomSubagentdata::getSubIncome(707);
?>
<style>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="app_button">
                ...
                <?php
                echo CHtml::beginForm('subuser', 'get', array('class'=>'input-append')),
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php $counts=0;$count2=0;$count3=0; foreach($nowDays as $k=> $v) {?>
                        <tr>
                            <td><?php echo $v;?></td>
                            <td><?php $aa=RomAppresource::getDayInstall($_GET['uid'],$k);$counts= $counts+$aa;echo $aa;?></td>
                            <?php $arr=RomSubagentdata::getDayActivationNum($_GET['uid'],$k);?>

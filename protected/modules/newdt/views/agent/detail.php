    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="page-header app_head">
                <h1 class="text-center text-primary">收益明细<small></small></h1>
                <!--    <span style="float: right;padding-top: 20px;padding-right: 20px;padding-bottom: 10px;">--><?php //echo "共".$count."条";?><!--</span>-->
            </div>
                <?php
                echo CHtml::beginForm('detail', 'get', array('class'=>'input-append')),
                    '<div class="input-group date form_date" data-date="" data-date-format="yyyy-mm" style="float: left;width: 200px" >
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(!empty($nowDays)){?>
                        <?php $counts=0;$count2=0;$count3=0; foreach($nowDays as $k=> $v) {?>
                            <tr>
                                <td><?php echo $v;?></td>
                                <td><?php $aa=RomAppresource::getDayInstall($this->uid,$k);$counts= $counts+$aa;echo $aa;?></td>
                                <?php $arr=RomSubagentdata::getDayActivationNum($this->uid,$k);?>

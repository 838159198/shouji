...
<div class="page-header app_head">
    <h1 class="text-primary"><span id="mh1">&nbsp;</span>装机助手套餐配置</h1>
</div>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'id' => 'admin-grid',
    'dataProvider' => $model->uidNosearch($this->uid,$no='MDAZRJ'),
    'pager'=>array(
...
//    'filter' => $model,
    'columns' => array(
        ...
        array(
            'header'=>'操作',
            'htmlOptions'=>array('class'=>'button-column','style'=>"width:120px;text-align:center;",'val'=>'help','id'=>'tc'),
            'class' => 'CButtonColumn',
            ...
            'buttons'=>array(
                'update'=>array(
                    'label'=>'选择套餐',
                    'imageUrl'=>null,
                    'options' => array('class'=>'btn btn-info'), // HTML 标签属性设置
                ),
...
<link rel="stylesheet" type="text/css" href="/css/newdt/boxmanage.css">
        ...
        <div class="pop">
            <div class="popMain">
                <div class="popTop">
                    <div style="width: 150px;font-size: 25px;margin: 7.5px auto;">路由套餐配置</div>
                 </div>
            <div class="popMiddle">
                    <div>

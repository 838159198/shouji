...
<div class="page-header app_head">
    <h1 class="text-primary"><span id="mh1">&nbsp;</span>路由器套餐配置</h1>
</div>
...
//    'filter' => $model,
    'columns' => array(
        ...
        array(
            'header'=>'套餐',
            'type'=>'raw',
            'value'=>'isset($data->b->pack_id)?Softroute::model()->getPackageNameById($data->b->pack_id):"--"',
            'htmlOptions'=>array('style'=>'text-align:center;'),
        ),
        array(
            'header'=>'操作',
            'htmlOptions'=>array('class'=>'button-column','style'=>"width:120px;text-align:center;",'val'=>'route','id'=>'tc'),
            'class' => 'CButtonColumn',

...
<div class="list-group" style="min-width:203px;">
    ...
    <a href="<?php echo Yii::app()->createUrl("/newdt/product");?>" class="list-group-item <?php if($a=="product_index"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 产品列表</a>
    <?php if($manageid==1 || $manageid=46){?>
    <a href="<?php echo Yii::app()->createUrl("/newdt/datashow/activatop");?>" class="list-group-item <?php if($a=="datashow_activatop"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 应用安装排行</a>

    <a href="<?php echo Yii::app()->createUrl("/newdt/datashow/instruction");?>" class="list-group-item <?php if($a=="datashow_instruction"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 业务说明</a>
    <?php }?>
    <a href="<?php echo Yii::app()->createUrl("/newdt/datashow/boxmanage");?>" class="list-group-item <?php if($a=="datashow_boxmanage"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 套餐配置</a>
    <?php if(($agent==99 ||$manageid==1) && $agent !=707 ){?>

        <a href="<?php echo Yii::app()->createUrl("/newdt/datashow/instalcheck");?>" class="list-group-item <?php if($a=="datashow_instalcheck"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 安装量分析</a>
    <?php }?>
    <?php if( ($agent==707 && $sign !=1) ||$manageid==1){?>
        <a href="<?php echo Yii::app()->createUrl("/newdt/agent/index");?>" class="list-group-item <?php if($a=="agent_index"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 子用户管理</a>
<!--        <a href="--><?php //echo Yii::app()->createUrl("/newdt/agent/subprice");?><!--" class="list-group-item --><?php //if($a=="agent_subprice"):?><!--list-group-item-infoA--><?php //endif;?><!--"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 子用户单价</a>-->
    <?php }?>

    <div  class="list-group-item activea "><b>财务管理</b></div>
    <?php if($uid!=707 && $agent!=707){?>
    ...
    <?php }?>
    <?php if( $agent==707 && $sign==1){?>
        <a href="<?php echo Yii::app()->createUrl($this->getModule()->id."/agent/detail");?>" class="list-group-item <?php if($a=="agent_detail"):?>list-group-item-infoA<?php endif;?>" target="_blank"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> 收益明细</a>
    <?php }?>
    ...
    <?php
        ...
        if($m["type"]==1 || $uid==760)
        {
            echo '<a href="/newdt/incomes/index" class="list-group-item"><span class="glyphicon glyphicon-yen" aria-hidden="true"></span> 子用户收益</a>';
        }
    ?>
    <div  class="list-group-item  activea "><b>个人信息</b></div>
    <a href="<?php echo Yii::app()->createUrl("/newdt/info");?>" class="list-group-item <?php if($a=="info_index"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> 我的信息</a>
    <a href="<?php echo Yii::app()->createUrl("/newdt/info/edit");?>" class="list-group-item <?php if($a=="info_edit"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> 资料修改</a>
    <?php if($agent!=69 ||($agent==69 && $uid==69) || $manageid==1): ?>
    <a href="<?php echo Yii::app()->createUrl("/newdt/info/bank");?>" class="list-group-item <?php if($a=="info_bank"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-credit-card" aria-hidden="true"></span> 财务信息修改</a>
    <?php endif; ?>
    <a href="<?php echo Yii::app()->createUrl("/newdt/info/password");?>" class="list-group-item <?php if($a=="info_password"):?>list-group-item-infoA<?php endif;?>"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span> 密码修改</a>

...
<script type="text/javascript">
    ...
    var MAIL_URL = '<?php echo $this->createUrl('/newdt/mail/count') ?>';
</script>
<style type="text/css">
    .qtip{
        margin-top:8px;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo Yii::app()->createUrl("/newdt");?>">首页</a></li>
                <li><a href="<?php echo Yii::app()->createUrl("/newdt/product");?>">产品列表</a></li>
                <li>
                    <?php echo CHtml::link('消息', array('mail/index'), array('id' => 'tipmail', 'title' => '没有新消息')) ?>
                </li>
                <li><a href="<?php echo Yii::app()->createUrl("/newdt/mail/index");?>" id="infocount"></a></li>

            </ul>

            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="padding-top: 18px"><?php echo Yii::app()->user->member_username;?> <span class="caret"></span></a>

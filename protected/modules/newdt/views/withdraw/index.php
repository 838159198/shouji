            ...
            <div class="row">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            本月预估收益：<span class="money"><?php echo $modelBill->cy;?></span>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的余额：<span class="money"><?php echo $modelBill->surplus>0 ? $modelBill->surplus : 0?></span>元
<!--                            --><?php
/*                            $m=Member::model()->getById($this->uid);
                            ...
                            */?>
                            ...
                            <!-- 业务流id=3320  押金金额 2017-12-13-->
                            <?php 
                            //     if(!empty($modelBill->surplus)){

                            //     }
                            // $sql="select dj_sum from `app_router_manage` where uid=".$this->uid;
                            ...
                            ?>
                            <span style="margin-left: 20px">押金金额：</span><span class="money"><?php echo $modelBill->dj_total?></span>元
                            <!-- end -->
                        </div>
                    </div>
                <?php if($bank_status==false){?>
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <div class="alert alert-danger" role="alert">请先填写财务信息，才可以提现哦 ^_^ <a href="/newdt/info/bank" class="lable">现在就去填写财务信息</a> </div>
                        </div>
                    </div>
                <?php }else{?>
                    <div class="panel panel-success">

...
<div class="mainpage">
    ...
    <div class="mainleft">
        <div class="maintit titwid1 hangyetext">
            <span><a href="/"> 首页 </a>> <a href="/<?php echo $data->category->pathname;?>"><?php echo $data->category->name;?></a></span><span class="more"><a href=""></a></span>
        </div>
        <div class="article">
            ...
            <div class='article_page'>
                    ...
                    <?php if(empty($datap)) {echo "没有了";} else { ?>
                        <a href="/notice/<?php echo $datap[0]['id']; ?>"> <?php echo $datap[0]['title']; ?> </a>
                    <?php } ?>
                    </br>
                    <strong>下一篇：</strong>
                    <?php if(empty($datan)) {echo "没有了";} else { ?>
                        <a href="/notice/<?php echo $datan[0]['id']; ?>"> <?php echo $datan[0]['title']; ?> </a>
                    <?php } ?>
                </div>

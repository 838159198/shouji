...
//var day1=parseInt(leftsecond/(24*60*60*6));
        ...
        if(leftTime > 0){
            cc.innerHTML = "距离报名截止日期还有<br><em>"+day1+"</em>天<em>"+hour+"</em>小时<em>"+minute+"</em>分<em>"+second+"</em>秒<br>参加活动的用户：";
        }else{
            cc.innerHTML = "本期活动报名已结束";
        }

    }
    window.setInterval(function(){ShowCountDown(2016,11,17,'daojishi');}, interval);
    $(function(){
        var _wrap=$('ul.line');
        var _interval=1000;
        var _moving;
    ...
    $(function () {
        $("#btnHB60").click(function(){
            ...
            else
            {
                ...
                {
                    var id=1;
                    var url='/member/campaignLog/ajaxCommit?id='+periods;
...
<div class="jdd-hd-top">
    <div class="st_product">
        <div class="st_product_row">
            <div class="st_product_icon"><img src="/css/hd/zzysj/images/apk/liulanqi.png" border="0"/></div>
            <div class="st_product_text">
                <p>活动产品：浏览器2</p>
                <p>活动单价：2.4元/台</p>
                <p>活动奖励：+20%的收益</p>
                <p>活动要求：安装在data区或system区，联网首次激活</p>
                <p>报名时间：2016年11月10日 - 2016年11月16日</p>
                <p>活动周期：2016年11月17日 - 2016年11月23日</p>


            </div>
            <div class="st_product_r">
                <div class="st_product_btn"><a href="javascript:void(0)"><input id="btnHB60" type="button" value="<?php echo $campaignlog?"已报名":"报名参加";?>" class="jdd-hd-cd_lib" style="width:150px;font-family: Microsoft YaHei,Arial, Helvetica, sans-serif;" /></a></div>
                <input type="hidden" name="islogin" id="islogin" value="<?php echo $uid;?>"><input type="hidden" name="periods" id="periods" value="<?php echo $periods;?>">
...
<div class="jdd-hd-min">
    ...
    <div class="jdd-hd-min-texta">
        <table width="100%" border="1" bordercolor="#a95d12" style="text-align: center;">
            ...
            <tr><td>第一名</td><td>va****</td><td>测试机一周使用权 + 10000积分</td></tr>
            <tr><td>第二名</td><td>wo****</td><td>测试机一周使用权 + 5000积分</td></tr>
            <tr><td>第三名</td><td>zh****</td><td>测试机一周使用权 + 3000积分</td></tr>
            <tr><td>第四名</td><td>ao****</td><td>1000积分</td></tr>
            <tr><td>第五名</td><td>zh****</td><td>1000积分</td></tr>
            <tr><td>第六名</td><td>di****</td><td>1000积分</td></tr>
            <tr><td>第七名</td><td>ha****</td><td>1000积分</td></tr>
            <tr><td>第八名</td><td>zs****</td><td>1000积分</td></tr>
            <tr><td>第九名</td><td>zi****</td><td>1000积分</td></tr>
            <tr><td>第十名</td><td>01****</td><td>1000积分</td></tr>
        </table>
    </div>
</div>
<div class="jdd-hd-min">
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"《周周赢手机 天天高收益》","bdDesc":"各位机友请注意：我正在速推APP推广联盟参加《周周赢手机 天天高收益》活动，您也来一起参加吧！","bdMini":"2","bdMiniList":false,"bdPic":"http://www.sutuiapp.com/css/hd/zzysj/images/apk/liulanqi.png","bdStyle":"0","bdSize":"32"},"slide":{"type":"slide","bdImg":"5","bdPos":"right","bdTop":"100"}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
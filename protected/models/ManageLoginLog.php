...
/**
 * This is the model class for table "{{manage_login_log}}".
 *
 * The followings are the available columns in table '{{manage_login_log}}':
 * @property integer $uid
 * @property integer $overtime
 * @property string $overip
 */
class ManageLoginLog extends CActiveRecord
{
	/**
	 ...
	 * @return ManageLoginLog the static model class
	 */

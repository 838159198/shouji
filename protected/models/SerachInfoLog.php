...
/**
 * This is the model class for table "{{serach_info_log}}".
 *
 * The followings are the available columns in table '{{serach_info_log}}':
 * @property string $id
 * @property string $mid
 ...
 */
class SerachInfoLog extends CActiveRecord
{
    /**
